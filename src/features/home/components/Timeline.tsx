...
const milestones: Milestone[] = [
  {
    ...
    title: "Foundation",
    description:
      "Gesitech Solutions Africa was established with a vision to provide safe and reliable LPG solutions across Africa.",
  },
  {
    year: "2018",
    title: "First Major Projects",
    description:
      "Successfully supplied and installed LPG accessories and completed our first LPG plant rectification projects for local businesses.",
  },
  {
    year: "2019",
    title: "Expansion of Services",
    description:
      "Introduced preventive and corrective maintenance services, helping clients improve safety and efficiency in LPG operations.",
  },
  {
    year: "2020",
    title: "Strengthening Partnerships",
    description:
      "Formed partnerships with leading global manufacturers to ensure supply of high-quality LPG accessories.",
  },
  {
    year: "2021",
    title: "Regional Reach",
    description:
      "Expanded operations to serve clients across multiple regions in Africa, supporting industrial and commercial LPG projects.",
  },
  {
    year: "2022",
    title: "Building Trust",
    description:
      "Recognized for excellence in safety and compliance, becoming a trusted partner for LPG distributors, industries, and institutions.",
  },
  {
    year: "2023",
    title: "Innovation and Training",
    description:
      "Launched consultancy and training services to build local capacity in safe LPG handling and plant operations.",
  },
  {
    year: "2024",
    title: "Sustainable Growth",
    description:
      "Continued expanding into new markets and investing in sustainable energy integration, positioning Gesitech Solutions Africa for the future.",
  },
  {
    year: "Today",
    title: "Trusted Energy Partner",
    description:
      "From 2017 to today, we remain committed to delivering innovative, safe, and sustainable LPG solutions that power Africa's growth.",
  },
];
